export const events = [
  {
    ...
    tiers: [
      { name: 'Participant', price: 'Free', perks: ['Event Access', 'Networking Lunch'] },
      { name: 'Pro Pass', price: '₹ 199', perks: ['Event Access', 'Networking Lunch', 'Workshop Kit', 'Certificate'] },
    ],
    registerUrl: '#',
  },
  {
    ...
    tags: ['Hackathon', 'Tech', '24H'],
    tiers: [
      { name: 'Solo', price: 'Free', perks: ['Meals Included', 'Cloud Credits'] },
      { name: 'Team (2-4)', price: 'Free', perks: ['Meals Included', 'Cloud Credits', 'Mentorship Sessions', 'Swag Kit'] },
    ],
    registerUrl: '#',
  },
  {
    ...
    tags: ['Workshop', 'UX', 'Design'],
    tiers: [
      { name: 'General', price: '₹ 99', perks: ['Workshop Kit', 'Certificate', 'Resource Pack'] },
    ],
    registerUrl: '#',
  },
  {
    ...
    tags: ['Talk', 'Inspiration', 'Alumni'],
    tiers: [
      { name: 'Open', price: 'Free', perks: ['Networking Opportunity', 'Refreshments'] },
    ],
    registerUrl: '#',
  },
  {
    ...
    tags: ['Workshop', 'Legal', 'IP'],
    tiers: [
      { name: 'General', price: '₹ 49', perks: ['IP Handbook', 'Q&A Access', 'Certificate'] },
    ],
    registerUrl: '#',
  },
  {
    ...
    tags: ['Social', 'Impact', 'Competition'],
    tiers: [
      { name: 'Team (up to 5)', price: 'Free', perks: ['Event Entry', 'Lunch', 'Pitch Coaching'] },
    ],
    registerUrl: '#',
  },
]

...
function HeroSection() {
  ...
  return (
    <section style={{ position: 'relative', height: '115vh', overflow: 'hidden', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      <OrbitalCanvas />
      ...
      >
        <motion.img
          ...
          alt={orbitData.title}
          style={{
            height: 'clamp(5.5rem, 16vw, 50rem)',
            width: 'auto',
            display: 'block',
